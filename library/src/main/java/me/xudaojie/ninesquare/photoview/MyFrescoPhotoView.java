 ...
 */
public class MyFrescoPhotoView extends SimpleDraweeView implements IPhotoView {

    private MyPhotoViewAttacher mAttacher;

    private ScaleType mPendingScaleType;

    public MyFrescoPhotoView(Context context) {
        this(context, null);
    }

    public MyFrescoPhotoView(Context context, AttributeSet attr) {
        this(context, attr, 0);
    }

    public MyFrescoPhotoView(Context context, AttributeSet attr, int defStyle) {
...
//            mAttacher = new PhotoViewAttacher(this);
            mAttacher = new MyPhotoViewAttacher(this);
        }
...
//    }
    ...
    public void setOnDrawableClickListener(MyPhotoViewAttacher.OnDrawableClickListener onDrawableClickListener) {
        mAttacher.setOnDrawableClickListener(onDrawableClickListener);
    }
}
